 ...
 *
 * 12 оролдлого нь өдөрт 40,000 захиалга байсан ч (боломжит 90,000-аас) чөлөөт
...
/**
 * `PMN-260806-48213` — огнооны хэсэг нь мөн Улаанбаатарын цагаар.
 *
 * ── Яагаад ТАВАН орон вэ (дөрөв биш) ─────────────────────────────
 *
 * Дугаар нь БАНКНЫ ГҮЙЛГЭЭНИЙ УТГА болдог. Давхцвал хоёр үйлчлүүлэгч ижил
 * утгаар мөнгө шилжүүлж, аль нь төлснийг ялгах арга байхгүй болно.
 *
 * Дөрвөн ороноор өдөрт 9,000 боломж байсан. Төрсөн өдрийн парадоксоор яг нэг
 * агшинд ирсэн 50 захиалгад давхцах магадлал 12.7% байв. Таван ороноор
 * 90,000 боломж болж, тэр магадлал **1.4%** болж буурна — арав дахин сайжирна.
 *
 * ── Яагаад ДАРААЛСАН дугаар БИШ вэ ───────────────────────────────
 *
 * «0001, 0002, 0003…» гэсэн дараалал нь ойлгомжтой мэт боловч ЭНЭ бүтцэд
 * илүү ДОР ажиллана. Дараалсан дугаар өгөхийн тулд «өнөөдрийн хамгийн их
 * дугаарыг уншаад нэг нэмэх» ёстой — уншилт ба бичилтийн хооронд зай үүсдэг.
 * Хоёр захиалга зэрэг ирвэл хоёулаа ижил утгыг уншиж, хоёулаа ижил дугаар
 * авна. Өөрөөр хэлбэл давхцал нь магадлалын биш, ЗААВАЛ болох зүйл болно.
 *
 * Үүнийг зөв хийхийн тулд атомик тоолуур хэрэгтэй. Захиалга R2 (объект сан)
 * дээр хадгалагддаг бөгөөд тэнд атомик тоолуур байхгүй. Firebase-ийн ETag
 * харьцуулалтаар хийж болох ч захиалга бүрд нэмэлт сүлжээний дуудлага,
 * шинэ унах цэг нэмнэ. Санамсаргүй + өргөн муж нь энэ хэмжээнд илүү зөв
 * солилцоо.
 *
 * ── Яагаад `taken` параметр вэ ────────────────────────────────────
 *
 * Дуудагч тал тухайн өдөр аль хэдийн ашиглагдсан дугааруудыг өгнө. Энэ нь
 * дараалан ирсэн захиалгуудын давхцлыг бүрэн арилгана — зөвхөн яг нэг
 * агшинд ирсэн захиалгууд бие биенээ хардаггүй.
 *
...
export const makeOrderNumber = (
  ...
  const make = (): string => `${prefix}${String(Math.floor(10000 + draw() * 90000))}`;
