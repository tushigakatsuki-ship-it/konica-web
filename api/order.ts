 ...
 *
 * ⚠️ Яагаад 5 биш 15 вэ — CGNAT:
 *
 * Монголын гар утасны операторууд олон хэрэглэгчийг НЭГ нийтийн IP-ийн ард
 * байрлуулдаг (carrier-grade NAT). Тиймээс «нэг IP» гэдэг нь «нэг хүн» гэсэн
 * үг биш: Unitel-ийн 20 хэрэглэгч зэрэг захиалга өгвөл сервер тэднийг нэг
 * хүн гэж харна. 5 гэсэн хязгаар нь халдагчийг биш, ЖИНХЭНЭ үйлчлүүлэгчийг
 * хаана — тэр нь хамгаалснаас учирсан хохирол нь их.
 *
 * 15 нь сурталчилгааны үеийн бодит ачаалалд хангалттай зай өгч, автомат
 * хэрэгслийн үймээнийг ч зогсоосон хэвээр.
 */
