...
sequenceDiagram
    ...
    W->>W: canvas — тайралт, эргэлт, өнгө<br/>300dpi хэвлэлийн JPEG үүсгэнэ
    ...
    A->>R2: PUT manifests/огноо/PMN-…-uploadId.json
    A-->>W: 201 { orderNumber, total, filesSaved }
...
| `print` + `original` хоёуланг хадгална | Тайралт буруу санагдвал, эсвэл өөр хэмжээгээр дахин хэвлэх шаардлага гарвал эх файл хэрэгтэй |
