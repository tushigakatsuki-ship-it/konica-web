...
| Талбар | Утга |
| --- | --- |
| Rule name | `uploads-30-days` |
| Prefix | `uploads/` |
| Action | Delete objects **30 days** after upload |
...
#### Яагаад 30 хоног вэ (зардлын биш, нууцлалын шийдвэр)

Зардал нь энд шийдэгч хүчин зүйл БИШ. R2 нь $0.015/GB сард, эхний 10GB үнэгүй —
дунд ачаалалд (өдөрт ~300 зураг) 30 хоног нь сард ~$0.7, 90 хоног нь ~$2.5.
Хоёулаа өчүүхэн.

Шийдвэрийг тодорхойлдог зүйл нь **хэрэглэгчийн зураг**: гэр бүлийн зураг, бичиг
баримт, заримдаа иргэний үнэмлэхний хуулбар. Эдгээрийг шаардлагатайгаас удаан
хадгалах нь ямар ч ашиггүй эрсдэл. 30 хоног нь дараах гурвыг бүгдийг багтаана:

* төлбөр удаж орох (зураг зөвхөн ТӨЛӨГДСӨН захиалгад татагддаг),
* дэлгүүрийн компьютер хэдэн өдөр унтарсан байх,
* «дахин хэвлээд өгөөч» гэсэн хүсэлт хожим ирэх.

⚠️ **1 хоног гэх мэт богино хугацаа тавьж БОЛОХГҮЙ.** Lifecycle дүрэм нь
файлын НАСЫГ л мэднэ — «ажилтан татаж авсан уу» гэдгийг мэдэхгүй. Баасан
гарагийн захиалгыг Даваа гарагт төлөхөд зураг нь аль хэдийн устсан байна.

> ⚠️ 30 хоног өнгөрөхөд R2 дээрх зураг **устана**. Дэлгүүрийн компьютер (эсвэл
> NAS) дээрх хуулбар цорын ганц болно. Түүнийгээ заавал нөөцөл (Hyper Backup /
> HBS3, эсвэл гадаад диск). RAID бол нөөцлөлт биш.
...
Хэвийн ачаалалд (өдөрт ~500 зураг, 30 хоногийн дүрэмтэй) сарын зардал **$1–2**
байх ёстой. $10 давбал ямар нэг зүйл буруу байна — ихэвчлэн lifecycle дүрэм
тавигдаагүй, эсвэл угтвар нь буруу бичигдсэн байдаг.
