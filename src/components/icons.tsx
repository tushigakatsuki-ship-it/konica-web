...
/**
 * Оч — «удахгүй нэмэгдэх зүйл» гэсэн утга.
 *
 * Тодорхой нэг үйлчилгээг заадаггүй нь ЗОРИУД: энэ дүрс нь есөн өөр
 * ангиллыг (медаль, өргөмжлөл, хувцас…) нэгтгэсэн хавтан дээр сууна.
 */
export const IconSparkle = (props: IconProps) => (
  <Base {...props}>
    <path d="M12 3.5 13.9 9 19.5 11l-5.6 2-1.9 5.5-1.9-5.5L4.5 11l5.6-2z" />
 ...
 * Facebook.
 *
 * ⚠️ Лого нь ДҮҮРГЭСЭН хэлбэртэй тул `Base`-ийн `stroke` загварыг дагахгүй.
 * Зураасаар зурвал танигдахаа больдог — брэндийн лого нь өөрийн хэлбэртэй,
 * түүнийг «манай дүрсний загварт тааруулах» нь буруу.
 */
