...
/**
 * `api/_files.ts` доторх `isDateStamp` мөн ижил хэвтэй — ЭНЭ НЬ ЗӨВШӨӨРӨГДСӨН
 * давхардал.
 *
 * Захиалгын дугаарын хэв давхардсанаас Telegram-ийн товч эвдэрсэн тул бүх
 * давхардлыг арилгах сэдэл төрөх нь зүйн хэрэг. Гэхдээ энэ хоёр ялгаатай:
 *
 *   • Захиалгын дугаарын дүрэм нь БИДНИЙХ бөгөөд бид өөрчилсөн (4 → 5 орон).
 *   • ISO огноо бол олон улсын тогтсон стандарт. Он 5 оронтой болохгүй.
 *     Өөрчлөгдөх боломжгүй дүрэмд «зөрөх» гэсэн эрсдэл байхгүй.
 *
 * Нэгтгэвэл клиент тал `api/` руу импорт хийх шаардлагатай болно — тэр нь
 * давхардлаас хамаагүй муу холбоос. Тиймээс ЗОРИУД тусад нь үлдээв.
 */
