        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_360px] lg:gap-10">
          <div>
            {/*
              ...
              * зургийг «стандарт хангасан» гэж дүгнээд зардаг байв.
              *
              * ⚠️ Гар аргаар тайрах (`CropStudio`) ХЭЗЭЭ Ч автоматжаагүй — энэ
              * хэвээрээ. Харин 2026 оны 8-р сараас `CropStudio` дотор жижиг,
              * ЗОРИУД хязгаарлагдмал засварын хэрэгсэл нэмэгдсэн: тодруулах,
              * blur, тодотгох, мөн ЗӨВХӨН жигд дэвсгэрт л идэвхждэг
              * цагаан/цэнхэр дэвсгэр сонголт (`src/lib/adjust.ts`,
              * `src/lib/backdrop.ts`). Эмх замбараагүй дэвсгэрт дэвсгэр
              * солих сонголт идэвхгүй харагдана — тэр тохиолдолд, мөн эцсийн
              * шалгалтад ажилтан лабораторид өөрөө бэлтгэсээр байна.
              */}
            <div className="card p-5 sm:p-6">
              <h2 className="text-lg font-bold">Онлайнаар захиалах</h2>
              <p className="mt-2 text-sm leading-relaxed text-ink-soft">
                Хэмжээгээ сонгоод зургаа оруулаарай. Хүсвэл гэрэлтүүлгээ
                тохируулж, жигд дэвсгэртэй бол цагаан/цэнхэр дэвсгэр рүү шууд
                сольж болно. Эцсийн бэлтгэлийг манай ажилтан лабораторид
                стандартын дагуу хийж, хэвлээд өгнө.
              </p>
