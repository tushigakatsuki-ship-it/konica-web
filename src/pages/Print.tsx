    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-14">
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
          ...
          {/*
            ...
            */}
          {/*
            * ⚠️ `/tseej-zurag/avtomat` — ЗАМ ӨӨРӨӨ ХАСАГДСАН, ЗӨВХӨН ЛИНК БИШ.
            *
            * Урьд нь энд «түр нуусан, зам хэвээр ажиллана» гэсэн тайлбар байсан
            * ч тэр ХУУЧИРСАН: тухайн бүрэн автомат хэрэгсэл (нүүр илрүүлэлт,
            * автомат тайралт) `App.tsx`-аас БҮРЭН хасагдаж, эх код нь
            * `_to_delete/`-д хадгалагдаж байна. Дахин нэмэхэд зөвхөн линк
            * буцаахад хангалтгүй — маршрут дахин бүртгэх шаардлагатай.
            *
            * Оронд нь харилцагчийн жижиг засварын хэрэгсэл (тодруулах, blur,
            * тодотгох, зөвхөн жигд дэвсгэрт цагаан/цэнхэр дэвсгэр солих)
            * доорх `PhotoEditor`/`CropStudio` дотор шууд нэмэгдсэн — `Adjust`
            * (`src/lib/adjust.ts`) төрлийг үз.
            */}
        </div>
        </>
        )}
        ...
        <div className="mt-5 grid gap-8 lg:grid-cols-[1fr_340px]">
          ...
          <div>
            {/*
              * ── Цээж зураг — гар тайралт + жижиг засварын хэрэгсэл ──
              *
              ...
              *
              * АВТОМАТ нүүр илрүүлэлт/тайралт ОДООГООР сэргээгдээгүй (яг
              * дээрх гурван шалтгаанаас болж) — тайралт хэвээрээ 100% гар
              * аргаар, `CropStudio`-ийн пан/зумаар.
              *
              * ⚠️ Гэхдээ 2026 оны 8-р сард ЖИЖИГ, аюулгүй хэсгүүдийг нэмсэн:
              * `CropStudio` дотор (зөвхөн `idPhoto` prop-той үед) тодруулах,
              * blur, тодотгох, мөн ЗӨВХӨН жигд (студи маягийн) дэвсгэрт л
              * идэвхждэг цагаан/цэнхэр дэвсгэр сонголт (`src/lib/adjust.ts`,
              * `src/lib/backdrop.ts`). Дэвсгэр солих логик өөрөө
              * `_to_delete/src/lib/idPhoto.ts`-ээс шилжсэн ч ЗӨВХӨН
              * дэвсгэртэй холбоотой хэсгүүд нь — нүүр илрүүлэлт, автомат
              * тайралт ОРООГҮЙ. Эмх замбараагүй дэвсгэр илрэвэл (`fitBackdrop`-
              * ийн `uniform: false`) сонголт идэвхгүй болж, харилцагчид
              * ажилтан бэлдэнэ гэдгийг тодорхой хэлнэ — хэзээ ч чимээгүй
              * буруу үр дүн гаргахгүй.
              */}
            {idPhoto && (
      ...
      {editorFor && (
        <PhotoEditor
          ...
          /*
           * `tab` БИШ `editorFor.service.category`-гаар шалгана: сагсны
           * мөрийг «Засах»-аар нээхэд (`Order`-ийн `onEdit`) `tab` тухайн
           * мөчид өөр байж болно, харин `service.category` үргэлж зөв.
           */
          idPhoto={editorFor.service.category === 'Цээж зураг'}
          /*
