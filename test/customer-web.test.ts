...
/**
 * 12 ангилал БҮГД тор дээр байх ёстой.
 *
 * Өмнө нь дөрвөн таб байсан тул найман ангилал вэб дээр ОГТ харагддаггүй
 * байв — медаль, өргөмжлөл, фудболк захиалах гэсэн хүн энд байгааг нь
 * мэдэх аргагүй. Каталогт ангилал нэмэгдвэл энэ тест сануулна.
 */
test('12 ангилал бүгд торон дээр харагдана', () => {
  const grid = read('src/components/CategoryGrid.tsx');
  ...
  for (const category of declared) {
    assert.ok(grid.includes(`key: '${category}'`), `${category} торон дээр алга`);
  }
